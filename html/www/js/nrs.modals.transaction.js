...
var NRS = (function (NRS, $, undefined) {
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    data = {
                                        ...
                                        "asset_name": asset.name,
                                        "quantity": [transaction.attachment.quantityQNT, asset.decimals],
                                        "price_formatted_html": NRS.formatOrderPricePerWholeQNT(transaction.attachment.priceNQT, asset.decimals) + " GD Premium ( GD2 )",
                                        "total_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(transaction.attachment.quantityQNT, transaction.attachment.priceNQT)) + " GD Premium ( GD2 )"
                                    };
                                    data["sender"] = transaction.senderRS ? transaction.senderRS : transaction.sender;
                                    infoTable.find("tbody").append(NRS.createInfoTable(data));
                                    infoTable.show();
                            ...
                            if (transaction.attachment.asset) {
                                NRS.sendRequest("getAsset", {
                                    ...
                                    data = {
                                        ...
                                        "asset_formatted_html": NRS.getTransactionLink(transaction.attachment.asset),
                                        "asset_name": asset.name,
                                        "amount_per_share": NRS.formatOrderPricePerWholeQNT(transaction.attachment.amountNQTPerQNT, asset.decimals) + " GD Premium ( GD2 )",
                    ...
                    case 2:
                        ...
                        NRS.sendRequest("getDGSGood", {
                            ...
                            data = {
                                ...
                                "item_name": goods.name,
                                "new_price_formatted_html": NRS.formatAmount(transaction.attachment.priceNQT) + " GD Premium ( GD2 )",
                                "seller": NRS.getAccountFormatted(goods, "seller")
                            };
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                if (purchase.quantity != "1") {
                                    ...
                                    data["total_formatted_html"] = orderTotal + " GD Premium ( GD2 )";
                                }
                    ...
                    case 7:
                        ...
                        NRS.sendRequest("getDGSPurchase", {
                            ...
                            NRS.sendRequest("getDGSGood", {
                                ...
                                data["order_total_formatted_html"] = NRS.formatAmount(orderTotal) + " GD Premium ( GD2 )";
                ...
                switch (transaction.subtype) {
                    case 0:
                        ...
                        data = {
                            ...
                            "min_reserve_per_unit_formatted_html": NRS.formatAmount(minReservePerUnitNQT) + " GD Premium ( GD2 )",
                        ...
                        if (currency) {
                            ...
                            data["current_reserve_per_unit_formatted_html"] = NRS.formatAmount(currentReservePerUnitNQT) + " GD Premium ( GD2 )";
                        } else {
                    ...
                    case 1:
                        if (currency) {
                            ...
                            data = {
                                ...
                                "amount_per_unit_formatted_html": NRS.formatAmount(amountPerUnitNQT) + " GD Premium ( GD2 )",
                                "reserved_amount_formatted_html": NRS.formatAmount(NRS.calculateOrderTotalNQT(amountPerUnitNQT, NRS.convertToQNTf(resSupply, currency.decimals))) + " GD Premium ( GD2 )"
                            };
                        } else {
                    ...
                    case 2:
                        if (currency) {
                            ...
                            data = {
                                ...
                                "claimed_amount_formatted_html": NRS.formatAmount(NRS.convertToQNTf(NRS.calculateOrderTotalNQT(reservePerUnitNQT, transaction.attachment.units), currency.decimals)) + " GD Premium ( GD2 )"
                            };
                        } else {
                            data = NRS.getUnknownCurrencyData(transaction);
                        }
    ...
    NRS.formatAssetOrder = function (asset, transaction, isModalVisible) {
        ...
        NRS.sendRequest("getOrderTrades", params, function (response) {
            ...
            data["total_traded"] = NRS.formatAmount(tradeTotal, false, true) + " GD Premium ( GD2 )";
        }, { isAsync: false });
    ...
    NRS.formatCurrencyExchange = function (currency, transaction, type) {
        var rateUnitsStr = " [ " + currency.code + " / GD Premium ( GD2 ) ]";
        var data = {
        ...
        NRS.sendRequest("getExchangesByExchangeRequest", {
            ...
            data["total_exchanged"] = NRS.formatAmount(exchangedTotal, false, true) + " [GD Premium ( GD2 )]";
        }, { isAsync: false });
        return data;
    };
