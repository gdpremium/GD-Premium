...
var NRS = (function(NRS, $) {
	NRS.defaultSettings = {
        ...
        "exchange": "-1",
        "console_log": "0",
		"fee_warning": "10000000000",
		"amount_warning": "1000000000000",
            ...
            async.waterfall([
                ...
                function(callback) {
                    for (var schema in NRS.defaultColors) {
						...
						//preload theme for empty setting
						//if (!color && schema == 'header'){color='dark-blue';}
						//if (!color && schema == 'boxes'){color='dark-blue';}
						//if (!color && schema == 'sidebar') {color='dark-gray';}
                        if (color) {
