...
var NRS = (function(NRS, $, undefined) {
	...
	NRS.initPluginWarning = function() {
		if (NRS.activePlugins) {
			...
			html += "Plugins are not sandboxed or restricted in any way and have full accesss to your client system including your GD Premium ( GD2 ) passphrase.";
			html += "</p>";
			...
			html += "you can loose your GD Premium ( GD2 )! In doubt don't run plugins with accounts ";
			html += "used to store larger amounts of GD Premium ( GD2 ) now or in the future.";
			html += "</p>";
			html += "</div>";
