...
public final class Nxt {
    ...
    static {
        ...
        System.out.println("Initializing GD Premium ( GD2 ) server version " + Nxt.VERSION);
    ...
    public static void shutdown() {
        ...
        Peers.shutdown();
        Db.shutdown();
        Logger.logShutdownMessage("GD Premium ( GD2 ) server " + VERSION + " stopped.");
        Logger.shutdown();
    ...
    private static class Init {
        ...
        static {
            try {
                ...
                Logger.logMessage("GD Premium ( GD2 ) server " + VERSION + " started successfully.");
                ...
                String forgerSecretPhrase = Nxt.getStringProperty("gd2.forgerSecretPhrase");
