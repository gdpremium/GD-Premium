...
//Logger.logDebugMessage("new builder 2");
    ...
    static TransactionImpl.BuilderImpl newTransactionBuilder(byte[] bytes) throws NxtException.NotValidException {
        try {
//Logger.logDebugMessage("new builder 3");
...
//Logger.logDebugMessage("new builder 4");
    ...
    static TransactionImpl.BuilderImpl newTransactionBuilder(JSONObject transactionData) throws NxtException.NotValidException {
        try {
//Logger.logDebugMessage("new builder 5");
  ...
  //          if (feeNQT>0){
//Logger.logDebugMessage("default dess in builder 5 = " + feeNQT);
//                  feeNQT = 25000000;
//}
//Logger.logDebugMessage("new feeNQT in builder 5 =" + feeNQT);
    ...
    public void validate() throws NxtException.ValidationException {
        ...
        if (!validatingAtFinish) {
            ...
            if (feeNQT < minimumFeeNQT) {
                throw new NxtException.NotCurrentlyValidException(String.format("Transaction fee %f GD Premium ( GD2 ) less than minimum fee %f GD Premium ( GD2 ) at height %d",
...
//Logger.logDebugMessage("get minimum fee NQT");
        long totalFee = 0;
        for (Appendix.AbstractAppendix appendage : appendages) {
            appendage.loadPrunable(this);
            if (blockchainHeight < appendage.getBaselineFeeHeight()) {
//Logger.logDebugMessage("min fees = 0");
  ...
  //   Logger.logDebugMessage("min fees=ppp");
        return totalFee;
    }
