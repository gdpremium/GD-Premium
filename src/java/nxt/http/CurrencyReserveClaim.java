...
/**
 * Claim currency units and receive back GD Premium ( GD2 ) invested into this currency before it became active
 * <p>
 * Parameters
 * <ul>
 * <li>currency - currency id
 * <li>units - the number of currency units claimed<br>
 * This value is multiplied by current currency rate and the result is added to the sender GD Premium ( GD2 ) account balance.
 * </ul>
 * <p>
 * Constraints
