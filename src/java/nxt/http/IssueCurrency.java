...
/**
 * Issue a currency on the GD Premium ( GD2 ) blockchain
 * <p>
 * A currency is the basic block of the GD Premium ( GD2 ) Monetary System it can be exchanged with GD2, transferred between accounts,
 ...
 * <li>minReservePerUnitNQT - the minimum GD Premium ( GD2 ) value per unit to allow the currency to become active
 * For {@link nxt.CurrencyType#RESERVABLE} currency
 ...
 * When a {@link nxt.CurrencyType#RESERVABLE} becomes active, in case it is {@link nxt.CurrencyType#CLAIMABLE} the GD Premium ( GD2 ) used for
 * reserving the currency are locked until they are claimed back.
 * When a {@link nxt.CurrencyType#RESERVABLE} becomes active, in case it is non {@link nxt.CurrencyType#CLAIMABLE} the GD Premium ( GD2 ) used for
